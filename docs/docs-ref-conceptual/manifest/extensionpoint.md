...
- **CustomFunctions** -适用于 Excel 编写 JavaScript 中的自定义函数。

[此 XML 代码示例](https://github.com/OfficeDev/Excel-Custom-Functions/blob/master/customfunctions.xml)演示如何使用**ExtensionPoint**元素的子元素与**CustomFunctions**属性值，用于。
...
> [!IMPORTANT] 
> 对于包含 ID 属性的元素，请确保您提供一个唯一的 id。 建议将你的公司名称用于此 ID。 例如，使用以下格式。 <CustomTab id="mycompanyname.mygroupname">
...
> [!NOTE]
> 此元素类型只支持 Office 365 中 web 上的 outlook 中。
